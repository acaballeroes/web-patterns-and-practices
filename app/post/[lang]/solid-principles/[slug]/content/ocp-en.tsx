    ...
    <>
      ...
      <div>
        ...
        <p>
          ...
          . At first glance, this seems contradictory. How can something be both
          open and closed?
        </p>
        <p>
          The answer lies in abstraction. OCP means you should add new behavior
          without rewriting existing code. When a new requirement arrives, you
          extend the system through new implementations, not by editing classes
          that already work.
        </p>
        <p>
        ...
        <p>
          In this article, we examine OCP through real scenarios: image storage
          systems and session export formats. We show how to take a violation
          and refactor it using the Strategy pattern.
        </p>
      </div>
        ...
        <CodeBlock language="csharp">{`public class PaymentProcessor
{
    ...
    private decimal ProcessPayPal(decimal amount)
    {
        ...
        <p className="mt-4">
          <span className="font-semibold">The problem:</span> Every new payment
          method requires modifying PaymentProcessor. Each modification risks
          breaking existing methods. Testing is complex because you test all
          methods together.
        </p>
    ...
    public decimal ProcessPayment(string paymentMethod, decimal amount)
    {
      ...
      <div>
        ...
        <p>
          ...
          needs to store images (session banners, community logos). Initially,
          Azure Blob Storage is the choice. But scaling to multiple regions and
          cloud providers requires AWS S3, Google Cloud Storage, or local
          storage options.
        </p>
        ...
        <CodeBlock language="csharp">{`public class ImageStorageService
{
        ...
        Stream imageStream, string fileName)
    {
        ...
        <p className="mt-4">
          This violates OCP: the class is closed for modification in theory but
          open in practice. Every new feature forces you to reopen and change
          it.
        </p>
...
public sealed class AwsS3StorageService : IImageStorageService
{
        ...
        string imageUrl, CancellationToken cancellationToken = default)
    {
        ...
        <p>
          Notice: the handler never changes, even when new storage providers are
          added.
        </p>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        <div className="rounded-lg border border-green-600 bg-green-50 p-4 my-6 dark:bg-green-950/30">
          ...
          <ul className="text-sm text-green-900 dark:text-green-100 space-y-2">
            ...
            <li>
              <span className="font-semibold">No risk:</span> A bug in AWS code
              cannot affect Azure.
            </li>
          </ul>
        </div>
      ...
      <div>
        ...
        <p>
          The same pattern applies anywhere you have variation. Here is another
          scenario: exporting session data in multiple formats (CSV, JSON, XML,
          PDF).
        </p>
      ...
      <div>
        ...
        <div className="rounded-lg border border-blue-600 bg-blue-50 p-4 my-4 dark:bg-blue-950/30">
          <ol className="list-decimal list-inside space-y-3 text-sm text-blue-900 dark:text-blue-100">
            <li>
              <span className="font-semibold">Identify variation points:</span>{" "}
            ...
            <li>
              <span className="font-semibold">Depend on the abstraction:</span>{" "}
  ...
  async handle(request: CreateSessionRequest): Promise<Result<Session>> {
    ...
    return success(session);
      ...
      <div>
        ...
        <p>
          As the system grows, the core service stays small. Only the number of
          implementations grows, each in its own file with its own tests.
        </p>
      ...
      <div>
        ...
        <p>
          Not everything needs an interface. Ask: &ldquo;Will this have multiple
          implementations?&rdquo; If no, keep it simple. Only abstract variation
          points.
        </p>
        ...
        <p>
          If your interface exposes implementation details, subclasses struggle.
          Keep the interface focused and clear.
        </p>
      ...
      <div>
        ...
        <p>
          ...
          regressions. It scales naturally: adding the tenth storage provider is
